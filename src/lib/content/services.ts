...
export const SERVICES: Record<string, Service> = {
  cleaning:{
    ...
    infoBlocks:[
      ...
      {t:'작업인원',s:'1일 1집 청소',d:'하루에 한 집을 하고 있으며 평수에 따라 2~5명까지 투입됩니다.',imgs:[rf('20240514_f6dec9685ec19.jpg'),rf('20240514_5a4fce4968948.jpg')]},
    ...
    process:[
      ...
      {t:'작업인원',d:'1일 1팀 책임청소. 하루에 한 곳만 진행하며 평수에 따라 2~5명까지 투입됩니다.',img:rf('20240514_f6dec9685ec19.jpg')},
  ...
  grout:{
    ...
    lead:'최고급 자재 8종과 섬세한 수작업으로 곰팡이와 물때 걱정 없는 청결한 공간을 완성합니다.',
    navDesc:'프리미엄 자재 8종',
