...
const cards = [
  { t: '100% 지부장 체계', d: '하청 없이 본사에서 직접 검증한 지부장들이 책임지고 시공합니다.' },
      ...
      <section>
        <div className="container" style={{ maxWidth: 1000 }}>
          ...
          <p className="muted reveal">
            ...
            전문으로 하는 홈케어 전문 기업입니다. 100% 지부장 체계로만 운영하며, 안전하고
          ...
          <div className="ceo-grid">
            ...
            <div>
              ...
              <p className="muted reveal" style={{ marginBottom: 12 }}>
                ...
                있습니다. <b style={{ color: 'var(--ink)' }}>100% 지부장 체계로만 운영</b>되며,
        ...
        <div className="container" style={{ maxWidth: 1000 }}>
          <div className="sec-head reveal" style={{ marginBottom: 36 }}>
            ...
            <p>
              ...
              있는 팀장님만 선별해 팀을 구성하고, 개선을 위해 매달 회의와 교육을 실시하고
              있습니다.
            </p>
          </div>
